...
public class TestBingTasks {

    private final static String PROP_NAME = "tse/appObjects/bingPages.properties";
    ...
    public TestBingTasks(SeleniumUtils utils) {
        this.utils = utils;
    ...
    public void typeSearchTxtField(HashMap<String, Object> paraMap) {
        ...
        stc.verifyTrue(utils.waitForElement((String) elemMap
                .get(TestBingConstants.BING_SEARCH_TXT_FIELD), 30));
        selenium.type((String) elemMap
                .get(TestBingConstants.BING_SEARCH_TXT_FIELD),
                (String) paraMap
                        .get(TestBingConstants.BING_SEARCH_TXT_FIELD));
    }
