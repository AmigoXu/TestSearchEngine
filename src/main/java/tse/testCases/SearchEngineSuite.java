...
public class SearchEngineSuite extends SeleneseTestCase {
    ...
    public static void main(String args[]){
        ...
        para.put("google_se_para_1", "/google_se_para_1.xml");
        para.put("google_se_para_2", "/google_se_para_2.xml");
        para.put("baidu_se_para_1", "/baidu_se_para_1.xml");
        para.put("bing_se_para_1", "/bing_se_para_1.xml");
